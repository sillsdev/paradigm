/* Title	: Shares
 * Author	: Richard Deeming http://www.codeproject.com/script/profile/whos_who.asp?id=34187
 * Info		: Adopted from the excellent work from Richard Deeming. see also his Network shares
...
namespace SIL.WordWorks.GAFAWS.FW60Converter
{
	...
	public class Share
	{
		...
		public bool MatchesPath(string path)
		{
			...
			return path.ToLowerInvariant().StartsWith(_path.ToLower());
		}
	}
	...
	public class ShareCollection : ReadOnlyCollectionBase
	{
		...
		/// <summary>Connect To Share with username and password</summary>
		...
		protected static void EnumerateSharesNT(string server, ShareCollection shares, ref bool accessDenied)
		{
			int level = 2;
		...
		public ShareCollection()
		{
			...
			EnumerateShares(_server, this, ref _accessDenied);
		}
		...
		/// <summary>
		/// Returns true if Access Denied error
		/// </summary>
